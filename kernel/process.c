  ...
  for (int i = 0; i < parent->total_mapped_region; i++)
  {
    ...
    case HEAP_SEGMENT:
      ...
      // when mapping the heap blocks
      {
        ...
        // only map the heap blocks (copy-on-write)
    ...
    case CODE_SEGMENT:
      ...
      map_pages(child->pagetable, parent->mapped_info[CODE_SEGMENT].va, parent->mapped_info[CODE_SEGMENT].npages * PGSIZE, lookup_pa(parent->pagetable, parent->mapped_info[CODE_SEGMENT].va), prot_to_type(PROT_READ | PROT_EXEC, 1));
